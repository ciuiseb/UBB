...
private:
    ...
    static void writeResult(T result, int rows, int cols) {
        ofstream pw(R"(C:\Users\ciuis\Desktop\FACULTATE\ANUL III\SEM I\PPD\lab-02\common\output.txt)");
        if (!pw.is_open()) {
    ...
    static void validateImpl(T result, int rows, int cols) {
        ifstream sc(R"(C:\Users\ciuis\Desktop\FACULTATE\ANUL III\SEM I\PPD\lab-02\common\output.txt)");
