package triathlon.persistence.abstracts;

import triathlon.model.*;
import triathlon.persistence.interfaces.Repository;
import triathlon.persistence.utils.DatabaseConfig;
...
//            log.error(e);
    ...
    public Optional<E> save(E entity) {
        ...
        String sql = String.format("INSERT INTO %s %s VALUES %s", tableName,getColumns(), getInsertParameters());
        try {
            ...
            try (Statement stmt = connection.createStatement();
                ...
                if (rs.next()) {
                    ...
                    ID typedId = (ID) Long.valueOf(generatedId);

                    return Optional.ofNullable(findOne(typedId).orElseThrow(() ->
                            new RuntimeException("Entity was saved but couldn't be retrieved")));
                } else {
