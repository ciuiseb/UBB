...
import triathlon.services.messaging.ActiveMQPublisher;
...
public class StartJsonServer {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Error starting ActiveMQ broker: " + e.getMessage());
        }
        ITriathlonServices serverImpl = getServerImpl();
        try {
    ...
    private static ITriathlonServices getServerImpl() {
        ...
        var broker = new ActiveMQPublisher("tcp://localhost:61616");

        ITriathlonServices serverImpl = new ServiceImpl(eventRepository,
