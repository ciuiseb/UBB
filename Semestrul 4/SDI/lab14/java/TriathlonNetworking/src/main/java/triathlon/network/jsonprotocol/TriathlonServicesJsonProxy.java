...
public class TriathlonServicesJsonProxy implements ITriathlonServices {
    ...
    private ITriathlonClient client;
    ...
    @Override
    public RefereeDiscipline login(Referee referee, ITriathlonClient client) throws TriathlonException {
        initializeConnection();
        this.client = client;
    ...
    @Override
    public void logout(Referee referee, ITriathlonClient client) throws TriathlonException {
