...
public class RefereeDashboardController implements ITriathlonClient {


    @FXML
    private Label refereeNameLabel, disciplineLabel, eventLabel;
    @FXML
    private Button logoutButton, updateScoreButton;
    @FXML
    private TableView<Result> disciplineScoresTable, totalPointsTable;
    @FXML
    private TableColumn<Result, String> disciplineParticipantColumn, totalPointsParticipantColumn;
    @FXML
    private TableColumn<Result, Integer> disciplineScoreColumn, totalPointsColumn;
    @FXML
    private RadioButton allParticipantsRadio, ungradedParticipantsRadio;
    @FXML
    ...
    public void handleResultUpdate(Result result) {
        Platform.runLater(() -> {
            if (result.getEvent().getId() == currentEvent.getId()) {
                loadResults();
            }
        });
    }
