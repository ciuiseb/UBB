...
import triathlon.client.fx.messaging.MessageBrokerConsumer;
...
public class LoginController {
    ...
    private void handleLogin(ActionEvent event) {
        ...
        try {
            ...
            messageBrokerConsumer = new MessageBrokerConsumer("tcp://localhost:61616");
            messageBrokerConsumer.setDashboard(dashboardController);
