...
public class UserDashboardController {
    ...
    @FXML
    private TableColumn<Notification, LocalDateTime> notificationDateColumn;
    @FXML
    ...
    private void setupToggleButtons() {
        ...
        notificationsToggleButton.setToggleGroup(toggleGroup);
        ...
        toggleGroup.selectedToggleProperty().addListener((observable, oldValue, newValue) -> {
            ...
            } else if (newValue == chatToggleButton) {
                friendsSection.setVisible(false);
                chatSection.setVisible(true);
                notificationsSection.setVisible(false);
                loadChat();
            } else if (newValue == notificationsToggleButton) {
                friendsSection.setVisible(false);
                chatSection.setVisible(false);
    ...
    private void loadFriends() {
        ...
        List<User> friends = service.getFriendsPage(currentUser.getId(), currentPage, PAGE_SIZE);
    ...
    private void setupNotificationsTable() {
        ...
        notificationDateColumn.setCellValueFactory(new PropertyValueFactory<>("dateTime"));
        notificationsTable.setItems(notificationsList);
    }

    private void loadNotifications() {
        notificationsList.setAll(service.getNotifications(currentUser.getId()));
    }
    ...
    private void updatePaginationControls() {
        ...
        int totalFriends = service.getTotalFriendsCount(currentUser.getId());
        totalPages = (int) Math.ceil((double) totalFriends / PAGE_SIZE);
